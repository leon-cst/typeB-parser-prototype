"""
Type B Parser -- API routes (Blueprint)

Moved out of app.py unchanged so create_app() can register this
alongside future blueprints (e.g. the agreement-table dashboard).
Route logic below is identical to the original app.py.
"""
